...
<fieldset>
  ...
  <div class="form-group">
    ...
    <label for="person_title" class="col-lg-4 control-label">Biztosított <strong>neme</strong>:</label>
    <div class="col-lg-3">
  ...
  <div class="form-group">
    <label for="birth_date" class="col-lg-4 control-label">Biztosított <strong>születési ideje</strong>:</label>
      <div class="col-lg-1">
        <input type="text" class="form-control" id="birth_year" placeholder="Év">
      </div>
      <div class="col-lg-1">
        <input type="text" class="form-control" id="birth_month" placeholder="Hónap">
      </div>
      <div class="col-lg-1">
        <input type="text" class="form-control" id="birth_day" placeholder="Nap">
      </div>
  </div>
